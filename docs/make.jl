...
makedocs(;
    ...
    pages=Any[
        ...
        "Examples"=>Any["Bell inequalities"=>"examples/bell.md", "Certifying Ground State"=>"examples/cert_ground_state.md","Trace Polynomial"=>"examples/trace_poly.md", "Werner State"=>"examples/werner_state.md"],
