...
function moment_relax(pop::StatePolyOpt{V,M,T}, cliques_cons::Vector{Vector{Int}}, global_cons::Vector{Int}, cliques_term_sparsities::Vector{Vector{TermSparsity{V,M}}}) where {V,M,T}
...
function constrain_moment_matrix!(
    ...
    local_basis::Vector{StateWord{V,M}},
