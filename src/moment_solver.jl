...
# function moment_relax(pop::PolyOpt{T}, cliques_cons::Vector{Vector{Int}}, global_cons::Vector{Int}, cliques_term_sparsities::Vector{Vector{TermSparsity{V,M}}}) where {V,M,T}
