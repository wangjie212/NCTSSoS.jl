using Test, NCTSSoS
using JuMP
using NCTSSoS: star, symmetric_canonicalize, cyclic_canonicalize, support, neat_dot, get_basis, get_dim, _comm, _projective, _unipotent, reducer, sorted_unique

using NCTSSoS.FastPolynomials: Monomial, Polynomial

# , symmetric_canonicalize, get_basis, support, neat_dot, get_dim, _comm, _unipotent, _projective, cyclic_canonicalize, reducer, sorted_unique
